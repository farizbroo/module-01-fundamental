...
// LOOPING STATEMENT : penulisan kode yang ditujukan untuk mengulang eksekusi suatu code
 ...
 * Aturan panulisan :
 * for (couterDeclaration; counter_condition; counter){
 *      // code
 * }
 */
