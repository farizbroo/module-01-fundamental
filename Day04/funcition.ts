 ...
 *  - Bisa menerima parameter/argumen : penampung dari function, untuk menerima nilai dari luar funcion
...
// INPUT : dua variable yang menampung data untuk di dijumlahkan
